...
namespace M1S05_Ex_4_a_6_Test
{
    public class CalculadoraTest
    {
        ...
        // Semana 05 - Exercício 4 - Subtração:
        [Fact]
        ...
        // Semana 05 - Exercício 5 - Subtração:
        [Fact]
        [Trait("Categoria", "Subtrair")]
        public void TestMetodoSubtrairDouble()
        {
            double resultado = Calculadora.Subtracao(5.50, 5.48);
        ...
        {
            float resultado = Calculadora.Subtracao(5.50f, 5.48f);
        ...
        // Semana 05 - Exercício 4 - Multiplicação:
        ...
        // Semana 05 - Exercício 5 - Multiplicação:
        [Fact]
        [Trait("Categoria", "Multiplicacao")]
